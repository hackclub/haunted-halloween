...
import Halloween from '../components/index/cards/haunted-halloween'
...
function Page({
  ...
  useEffect(() => {
    const handler = event => {
      ...
      spotlightRef.current.style.background = `radial-gradient(
        circle at ${x}px ${y}px,
        rgba(107, 33, 168, 0) 10px,
        rgba(255, 117, 24, 0.9) 80px
      )`
    }
              ...
              >
                ...
                <Text
                  ...
                  sx={{
                    ...
                    alignSelf: 'center',
                    color: '#39ff14',
                    textShadow: '0 0 10px #6b21a8, 0 0 10px #ff7518, 0 0 10px #000'
                  }}
                >
          ...
          >
            <Badge
              ...
              sx={{
                ...
                textDecoration: 'none',
                fontWeight: 'normal',
                ':hover': { opacity: 1, bg: '#ff7518', color: '#000000' },
  ...
  <Box as="section" sx={{ py: [4, 5, '82px'], color: '#ff7518' }}>
          <Box
            sx={{
              position: 'relative',
              width: '90vw',
            ...
            >
              ...
              <Text
                ...
                sx={{
                  ...
                  color: '#000000',
                  background: 'linear-gradient(90deg, #ff7518, #6b21a8)',
            ...
            <Grid columns={[1, 1, 1, '2.5fr 3fr']} gap={[0, 3, 4]} pt={[3, 4]}>
              ...
              >
                <Grid
                  ...
                  as="li"
                >
                  <Text as="span" sx={{ color: '#ff7518' }} aria-hidden="true">
                    1
                  </Text>
                ...
                <Grid
                  ...
                  as="li"
                >
                  <Text as="span" sx={{ color: '#39ff14' }} aria-hidden="true">
                    3
                  </Text>
                  <Text as="p" variant="subtitle">
        ...
        <Box
          ...
          sx={{
            backgroundImage: `
              linear-gradient(rgba(107, 33, 168, 0.7), rgba(255, 117, 24, 0.7)),
              url('https://icons.hackclub.com/api/icons/0x6b21a8/glyph:rep.svg')
            `,
        ...
        <Box>
          ...
          <Box
            sx={{
              position: 'relative',
              background: '#000000',
              backgroundImage: `url('https://icons.hackclub.com/api/icons/0x39ff14/glyph:rep.svg')`,
              backgroundSize: '40px 40px',
              backgroundRepeat: 'repeat',
          ...
          >
            ...
            >
              <Card
                ...
                sx={{
                  background:
                    'linear-gradient(32deg, rgba(255, 117, 24, 0.9) 0%, rgba(107, 33, 168, 0.9) 100%)',
                  color: '#39ff14',
                  svg: { color: '#39ff14' },
                  position: 'relative',
                  '.icon': {
              ...
              <Card
                sx={{
                  background:
                    'linear-gradient(-32deg, #6b21a8 14%, #ff7518 82%)',
                  color: '#39ff14',
                  svg: { color: '#39ff14' },
                  textDecoration: 'none',
                  position: 'relative',
              ...
              <Card
                sx={{
                  background:
                    'linear-gradient(to bottom, #ff7518 0%, #6b21a8 100%)',
                  color: '#39ff14',
                  svg: { color: '#39ff14' },
                  textDecoration: 'none',
                  position: 'relative',
      ...
      <Footer
        ...
        sx={{
          ...
          position: 'relative',
          overflow: 'hidden',
          textShadow: '0 1px 2px #6b21a8',
          'h2,span,p,a': { color: '#ff7518 !important' },
          '> div img': { objectPosition: ['left', 'center'] },
          svg: {
            fill: '#39ff14',
            filter: 'drop-shadow(0 1px 2px #ff7518)'
          }
        }}
      >
        <style>
